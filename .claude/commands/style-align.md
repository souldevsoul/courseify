...
**Primary:**
- 🔵 Blue (Educational, Trust): `blue-600`, `blue-500`, `blue-700`
- 🟢 Emerald (Growth, Success): `emerald-500`, `emerald-400`, `emerald-600`
- 🟣 Violet (Creativity, Learning): `violet-600`, `violet-500`, `violet-700`
...
**NEVER use (these are from other templates):**
- ❌ Yellow (`yellow-*`)
- ❌ Orange (`orange-*`)
...
shadow-glow-violet    // Violet glow effect
```
...
**Checklist:**
- [ ] Colors match LogoSmith palette (emerald/blue)
...
### After (LogoSmith style - soft, emerald/blue)
```tsx
...
1. **Commit with clear message**: `git commit -m "Align [PageName] to LogoSmith design system"`
