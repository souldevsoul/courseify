        ...
        >
          <Stack align="center" gap="md" p="xl">
            <div className="relative">
              ...
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-green-400 border-4 border-black shadow-lg">
            ...
            <div className="text-center">
              ...
              <Group justify="center" gap={4}>
                <Badge variant="filled" color="yellow" size="sm" className="bg-green-400 text-black border-2 border-black font-bold uppercase">
        ...
        {uploadedFiles.length > 0 && (
          <Stack gap="sm">
            <Group justify="space-between" align="center">
              ...
              <Badge variant="filled" size="lg" radius="sm" className="bg-green-400 text-black border-2 border-black font-bold uppercase">
