    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="relative bg-green-400 border-b-8 border-black p-6">
            <button
              onClick={handleClose}
              className="absolute top-4 right-4 w-10 h-10 bg-black text-green-400 flex items-center justify-center hover:bg-gray-900 transition-colors"
              aria-label="Close"
            >
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-black mb-3">
                  <RiSparklingLine className="w-5 h-5 text-green-400" />
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-3 border-4 border-black focus:outline-none focus:ring-4 focus:ring-green-400 font-mono text-sm"
                  />
                </div>
              </div>
              ...
              <Button
                ...
                size="lg"
                disabled={isLoading}
                className="w-full gap-3 bg-black text-green-400 hover:bg-gray-900 border-4 border-black font-bold uppercase brutalist-shadow disabled:opacity-50"
              >
                {isLoading ? (
                  <>
          ...
          {/* Bottom Accent */}
          <div className="h-4 bg-green-400 border-t-4 border-black" />
        </div>
      </div>
    </>
  )
