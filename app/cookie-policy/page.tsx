          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8 text-gray-700">
              <section>
                ...
                <p>
                  Coursify uses cookies and similar tracking technologies to track activity on our service and store certain information. This Cookie Policy explains what cookies are, how we use them, and your choices regarding their use.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="p-6 border-2 border-purple-200 rounded-xl bg-green-50">
              ...
              <section>
                ...
                <div className="mt-6 p-6 border-2 border-purple-200 rounded-xl bg-black text-white">
                  <h3 className="text-lg font-bold uppercase mb-3 text-purple-500">Browser Cookie Settings</h3>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Google Privacy Policy: <a href="https://policies.google.com/privacy" className="text-green-600 hover:underline">policies.google.com/privacy</a></li>
                  <li>Facebook Data Policy: <a href="https://www.facebook.com/privacy" className="text-green-600 hover:underline">facebook.com/privacy</a></li>
                  <li>Stripe Privacy Policy: <a href="https://stripe.com/privacy" className="text-green-600 hover:underline">stripe.com/privacy</a></li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="mt-4 p-6 border-2 border-purple-200 rounded-xl bg-white">
                  <p><strong>Email:</strong> support@coursify.ai</p>
                  <p><strong>Address:</strong> Coursify, Inc., 123 Voice Street, Suite 100, San Francisco, CA 94105, United States</p>
                </div>
              </section>
            </div>
          </div>
